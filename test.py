...
def Megfelelo(year,month,day):
    ...
    if dayname == "Saturday" or dayname == "Sunday" or Unnep(year,month,day): 
        return True
    else:
        return False
sYear = 2024
...
p2 = Paragraph("szeptember 1. - szeptember 30.",date_style)
...
HeaderTable = Table(header, colWidths=[0.5*inch, 0.6*inch,0.75*inch, 0.3*inch, 0.75*inch, 0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,],
...
for i in range(1,17):
    ...
    _table = Table(day, colWidths=[0.5*inch, 0.6*inch,0.75*inch, 0.3*inch, 0.75*inch, 0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,0.75*inch, 0.3*inch, 0.75*inch,],
